...
# from algoverify.solvers.sdp_cgal_solver.lanczos import lanczos
...
def solve_separable_sdp(c, B, l, u, psd_sizes, sigma, rho, k):
    ...
    proj = create_algoverify_projection(l, u, psd_sizes)
...
def create_algoverify_projection(l, u, psd_sizes):
    """
