...
def plot_res_times(df, plot_fname, title):
    ...
    ax0.plot(K_vals, df['sdp_c'], label='custom_canon')
    ...
    ax1.plot(K_vals, df['sdp_ctime'], label='custom_canon')
...
def main():
    data_fname1 = \
        '/Users/vranjan/Dropbox (Princeton)/ORFE/2022/algorithm-certification/experiments/NUM/data/test_custom_cross.csv'
    plot_fname1 = \
        '/Users/vranjan/Dropbox (Princeton)/ORFE/2022/algorithm-certification/experiments/NUM/data/test_custom_cross.pdf'
    title1 = 'small NUM example with custom canonicalizer'
