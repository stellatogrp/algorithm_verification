...
def plot_res_times(df, plot_fname):
    ...
    ax0.plot(K_vals, df['sdp_c'], label='custom WIP')
    ...
    ax1.plot(K_vals, df['sdp_ctime'], label='custom WIP')
    ...
    ax0.legend()
    fig.suptitle('NNLS example, m=5, n=3')
...
def main():
    data_fname = \
        '/Users/vranjan/Dropbox (Princeton)/ORFE/2022/algorithm-certification/experiments/NNLS/data/test_custom.csv'
    plot_fname = \
        '/Users/vranjan/Dropbox (Princeton)/ORFE/2022/algorithm-certification/experiments/NNLS/data/test_custom.pdf'
