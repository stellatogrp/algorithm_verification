...
def partial_nonneg_orthant_proj_canon(step, model, k, iter_to_gp_var_map, param_to_gp_var_map, iter_to_id_map):
...
def partial_nonneg_orthant_proj_bound_canon(step, k, iter_to_id_map,
